...
Locinputs = {0:['run09_20110424_weimer','run09QuietWei110424_Loc1_<>_AltInt.txt','-1.0'],\
          1:['run10_20110428_weimer','run10StormWei110428_Loc1_<>_AltInt.txt','-1.0'],\
          2:['run12_20110424_amie','run12QuietAmi110424_Loc1_<>_AltInt.txt','-1.0'],\
          3:['run13_20110428_amie','run13StormAmi110428_Loc1_<>_AltInt.txt','-1.0'] }
