#!/usr/bin/env python
#-----------------------------------------------------------------------------
# $Id: gitm.py,v 1.11 2013/12/06 18:46:59 agburr Exp $
#
...
class GitmBin(PbData):
    ...
    def append_units(self):
        ...
        unit_dict = {"Altitude":"m", "Ar Mixing Ratio":"", "Ar":"m^{-3}",
                     ...
                     "N2 density":"m^{-3}", # New name
                     "O Cooling":"[]",
                     "Ion Velocity (north)":"m s^{-1}",
                     "EUV Heating":"[]",
                     "CO2 Cooling": "[]",
                     "Ion Velocity (up)":"m s^{-1}",
                     "Electron Density":"m^{-3}",
                     "O+ density":"m^{-3}",
                     "Neutral Velocity (east)":"kg m s^{-1}",
                     "NO Density":"m^{-3}",
                     "N density":"m^{-3}",
                     "Neutral Velocity (north)":"m s^{-1}",
                     "O Density":"m^{-3}",
                     "Chemical Heating":"[]",
                     "Neutral Velocity (up)":"m s^{-1}",
                     "Ion Velocity (east)":"m s^{-1}",
                     "Auroral Heating":"[]",
                     "NO Cooling":"[]",
                     ...
                     "Region 2 Current":"A m^{-2}",
                     "Region 1 Current":"A m^{-2}",
                     "Specific heat":"J???",
                     "O2 density":"m^{-3}",
                     "E field (north)":"V m^{-1}",
                     "E field (east)":"V m^{-1}",
        ...
        scale_dict = {"Altitude":"linear", "Ar Mixing Ratio":"linear",
                    ...
                    "N2 density":"exponential", # New name
                     "O Cooling":"linear",
                     "Ion Velocity (north)":"linear",
                     "EUV Heating":"linear",
                     "CO2 Cooling": "linear",
                     "Ion Velocity (up)":"linear",
                     "Electron Density":"exponential",
                      "O+ density":"exponential",
                     "Neutral Velocity (east)":"linear",
                     "NO Density":"exponential",
                      "N density":"exponential",
                     "Neutral Velocity (north)":"linear",
                     "O Density":"exponential",
                     "Chemical Heating":"linear",
                     "Neutral Velocity (up)":"linear",
                     "Ion Velocity (east)":"linear",
                     "Auroral Heating":"linear",
                     "NO Cooling":"linear",
                     "Neutral Temperature":"linear",
                     "Joule Heating":"linear",
                     "PhotoElectron Heating":"linear",
                     "Neutral Density":"exponential",
                     "Region 2 Current":"linear",
                     "Region 1 Current":"linear",
                     "Specific heat":"linear",
                      "O2 density":"exponential",
                      "E field (north)":"linear",
                      "E field (east)":"linear",
                     "E field (up)":"linear"
        }
        ...
        name_dict = {"Altitude":"Altitude",
                     ...
                     "PressGrad (up)":r"$\nabla_{up}$ (P$_i$ + P$_e$)",
                     "IN Collision Freq":r"$\nu_{in}$",
                      "N2 density":"[N$_2$]", # New name
                     "O Cooling":"O Cooling",
                     "Ion Velocity (north)":"Ion Velocity (north)",
                     "EUV Heating":"EUV Heating",
                     "CO2 Cooling": "CO2 Cooling",
                     "Ion Velocity (up)":"Ion Velocity (up)",
                     "Electron Density":"Electron Density",
                     "O+ density":"O+ density",
                     "Neutral Velocity (east)":"Neutral Velocity (east)",
                     "NO Density":"NO Density",
                     "N density":"N Density",
                     "Neutral Velocity (north)":"Neutral Velocity (north)",
                     "O Density":"O Density",
                     "Chemical Heating":"Chemical Heating",
                     "Neutral Velocity (up)":"Neutral Velocity (up)",
                     "Ion Velocity (east)":"Ion Velocity (east)",
                     "Auroral Heating":"Auroral Heating",
                     "NO Cooling":"NO Cooling",
                     "Neutral Temperature":"Neutral Temperature",
                     "Joule Heating":"Joule Heating",
                     "PhotoElectron Heating":"PhotoElectron Heating",
                     "Neutral Density":"Neutral Density",
                     "Region 2 Current":"Region 2 Current",
                     "Region 1 Current":"Region 1 Current",
                     "Specific heat":"Specific Heat",
                     "O2 density":"O2 Density",
                     "E field (north)":"E Field (North)",
                     "E field (east)":"E Field (East)",
                     "E field (up)":"E Field (Up)"
        }
